...
const _validMsg = _('A path relative the home directory');
...
var FlatsealRelativePathRow = GObject.registerClass({
    ...
    Template: 'resource:///com/github/tchx84/Flatseal/relativePathRow.ui',
    ...
    _validate() {
        ...
        if (this._pathRE.test(this.text)) {
            ...
            this._image.set_tooltip_text(_validMsg);
            return;
        }
